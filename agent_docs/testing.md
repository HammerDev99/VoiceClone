...
tests/
  ...
  test_settings.py          carga de .env, persistencia de VOICE_ID, temperature
  ...
  test_anthropic_client.py  wrappers del SDK Anthropic (mocks, temperature)
...
Total: **97 tests**. La app Streamlit se valida con `streamlit.testing.v1.AppTest`
